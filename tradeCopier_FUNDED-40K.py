...
MT5_LOGIN: int =  52611395
MT5_PASSWORD: str = "Hk30ZH&z$mNf9u"
...
MT5_TERMINAL_PATH: str = r"C:\MT5\TradeCopier-263269\FUND_40K-LiveHedgeCopier\terminal64.exe"
...
VOLUME_MODE: str = "multiplier"  # use K × master's % risk
...
HALT_CLOSE_ALL: bool = False          # close all copier positions on halt
...
def poll_loop():
    ...
    LOG(f"[mode] VOLUME_MODE={VOLUME_MODE}, PNL_PARITY_MODE={PNL_PARITY_MODE}")
