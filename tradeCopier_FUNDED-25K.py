...
MT5_LOGIN: int =  11019230
MT5_PASSWORD: str = "-]OZAIx6B"
MT5_SERVER: str = "FundingPips Corp (2)"
...
MT5_TERMINAL_PATH: str = r"C:\MT5\TradeCopier-263269\FUND_25K\terminal64.exe"
...
DEFAULT_STOP_DISTANCE_PRICE = {
    ...
    "BTCUSD": 500.0,    # $500 fallback, tweak if needed
}

# ---- Daily loss cap (ONLY cap retained) ----
# MAX DAILY LOSS FOR THIS ACCOUNT = 3% ($750)
# MAX LOSS FOR THIS ACCOUNT = 6% ($1500)
DAILY_LOSS_LIMIT_PCT: float = 0.0275   # e.g., 0.10 = 10% of day-start equity
HALT_CLOSE_ALL: bool = True          # close all copier positions on halt

# ---- Files ----
STATE_PATH: str = "copier_state_25k.json"
