...
MT5_LOGIN: int =  11650298
MT5_PASSWORD: str = "qxcTH48##"
MT5_SERVER: str = "FundedNext-Server"
...
MT5_TERMINAL_PATH: str = r"C:\MT5\TradeCopier-263269\FUND_2K\terminal64.exe"
...
DAILY_LOSS_LIMIT_PCT: float = 0.04   # e.g., 0.10 = 10% of day-start equity
HALT_CLOSE_ALL: bool = True          # close all copier positions on halt

# ---- Files ----
STATE_PATH: str = "copier_state_5k.json"
